...
const CheckImage = ({highlightAcctNum, highlightRoutingNum}) => (
  <svg viewBox="0 0 543 73" style={{width: '100%'}}>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g fill={highlightRoutingNum ? '#8d52d1' : '#000'} fillRule="nonzero" style={{transition: 'fill 0.2s'}}>
      ...
      <g fill={highlightAcctNum ? '#8d52d1' : '#000'} fillRule="nonzero" style={{transition: 'fill 0.2s'}}>
