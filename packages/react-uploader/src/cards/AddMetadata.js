...
class TitleMonitor extends React.PureComponent {
    ...
    render() {
        ...
        if (this.state.isValid) {
            ...
            return <div style={{...style, border: '2px solid #B75B5B', color: '#B75B5B'}}>
    ...
    <Card style={{flexDirection: 'row'}}>
        ...
        <div>
            ...
            <span style={{display: 'block', marginBottom: '0.5em'}}>
                {gettext('Would you like us to automatically add it for you? This will show episode and podcast information in non-podcast apps.')}
            </span>
            <TitleMonitor />
            <div>
