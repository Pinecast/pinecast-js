    ...
    <Card style={{flexDirection: 'row'}}>
        ...
        <div>
            <b style={{display: 'block'}}>
                {gettext('There are some problems with your image.')}
            </b>
            <span style={{display: 'block', marginBottom: '0.5em'}}>
                {gettext('We detected some issues with the image you chose. We can fix these problems for you, if you would like.')}
            </span>
