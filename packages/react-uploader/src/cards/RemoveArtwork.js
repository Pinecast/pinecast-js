...
export default ({onAccept, onCancel}) =>
    <Card style={{textAlign: 'center'}}>
        ...
        <span style={{display: 'block', marginBottom: '0.75em'}}>
            {gettext('Removing artwork will revert to the podcast cover art on your feed podcast website. To change artwork in podcast apps, you must upload a new audio file.')}
        </span>
        <div>
